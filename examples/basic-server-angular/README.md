...
An MCP App example with an Angular UI using standalone components and signals.
...
- Angular UI using the [`App`](https://apps.extensions.modelcontextprotocol.io/api/classes/app.App.html) class
...
- [`mcp-app.html`](mcp-app.html) / [`src/app.component.ts`](src/app.component.ts) - Angular UI using `App` class
