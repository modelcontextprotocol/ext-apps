...
| [![Basic React](examples/basic-server-react/grid-cell.png "Starter template: MCP App with React UI")](examples/basic-server-react) | [![Integration Test](examples/integration-server/grid-cell.png "E2E integration testing example")](examples/integration-server) | |
| [**Basic React**](examples/basic-server-react) | [**Integration Test**](examples/integration-server) | |
