...
- Host SHOULD use `resources/read` to fetch the referenced resource URI at some point, but MAY ingest the resource out-of-band and store it on their own servers
