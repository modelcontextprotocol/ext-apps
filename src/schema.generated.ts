...
export const McpUiHostContextSchema = z.object({
    ...
    theme: z.union([z.literal("light"), z.literal("dark"), z.literal("system")]).optional().describe("Current color theme preference."),
    /** @description How the UI is currently displayed. */
    displayMode: z.union([z.literal("inline"), z.literal("fullscreen"), z.literal("pip"), z.literal("carousel")]).optional().describe("How the UI is currently displayed."),
