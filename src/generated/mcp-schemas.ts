 ...
 */
export const CancelledNotificationParamsSchema =
  NotificationParamsSchema.extend({
    /**
 ...
 */
export const ResourceUpdatedNotificationParamsSchema =
  NotificationParamsSchema.extend({
    /**
 ...
 * @category `tasks/result`
 */
export const GetTaskPayloadResultSchema = ResultSchema.and(
 ...
 */
export const TaskStatusNotificationParamsSchema =
  NotificationParamsSchema.and(TaskSchema);
 ...
 */
export const LoggingMessageNotificationParamsSchema =
  NotificationParamsSchema.extend({
    /**
 ...
 */
export const ElicitationCompleteNotificationSchema =
  JSONRPCNotificationSchema.extend({
 ...
 * @internal
 */
export const URLElicitationRequiredErrorSchema =
  JSONRPCErrorResponseSchema.omit({ error: true }).extend({
